...
class __TwigTemplate_55941189c9e7e410d57a8e6b4e58c55971515ca340ac23694bf70c38499c8385 extends Twig_Template
{
          ...
          <div class=\"box box-primary\">
            <form id=\"register_trabajador_form\"  action=\"\" method=\"POST\">
              ...
              <div class=\"box-body col-sm-4\">  
                ...
                <div class=\"form-group\">Fecha Nacimiento
                  <input class=\"form-control\" name=\"f_nacimiento\" id=\"f_nacimiento\" type=\"date\" value='{{ \"now\"|date(\"Y-m-d\") }}'/>
                </div>
                <div class=\"form-group\">Cargo
                  <select name='cargo' id='cargo' class='form-control'>
                    <option selected='selected'>--</option>
                    {% for p in cargos_db if false != cargos_db %}
                      <option value='{{ p.id_cargo }}'>{{ p.descripcion }}</option>
                    {% endfor %}
                  </select>
                </div>
                <div class=\"form-group\">Area
                  <select name='area' id='area' class='form-control'>
                    <option selected='selected'>--</option>
                    {% for p in areas_db if false != areas_db %}
                      <option value='{{ p.id_area }}'>{{ p.descripcion }}</option>
                    {% endfor %}
                  </select>
                </div>
                <div class=\"form-group\">
...
{% endblock %}
", "rrhh/nuevo_trabajador.twig", "C:\\xampp\\htdocs\\intranietsen\\app\\templates\\rrhh\\nuevo_trabajador.twig");
    }
}
