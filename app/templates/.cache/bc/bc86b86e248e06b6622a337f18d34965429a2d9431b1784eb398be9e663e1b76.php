...
class __TwigTemplate_b4272240e26fcf14134426cc32660e93b45464ff40930dac5e88921f082d1532 extends Twig_Template
{
          ...
          <div class=\"box box-primary\">
            <form id=\"editar_actividad_form\"  action=\"\" method=\"POST\">
              ...
              <div class=\"box-body col-sm-4\">
                ...
                <div class=\"form-group\">
                    <input class=\"form-control\" name=\"actividad\" id=\"actividad\" type=\"text\" placeholder=\"Nombre de la actividad\" value='{{ db_actividad.actividad }}' required/>
                </div>
                <div class=\"panel-footer text-center\">
                  <button type=\"button\" id=\"update_actividad\" class=\"btn btn-default\">Grabar</button>
                </div>
...
{% endblock %}
", "confirmacion/actividad/editar_actividad.twig", "C:\\xampp\\htdocs\\intranietsen\\app\\templates\\confirmacion\\actividad\\editar_actividad.twig");
    }
}
