...
class __TwigTemplate_3d3331d64ad298f3a550207d1022e67d603b970bde9b2bb64bb5c5801bbd93a3 extends Twig_Template
{
    ...
    <div class=\"row\">
      <div class=\"col-sm-12\">
        <form id=\"editar_resultado_form\" action=\"\" method=\"POST\">
          ...
          <div class=\"box-body col-sm-4\">
            <div class=\"form-group\">
              <input class=\"form-control\" name=\"nombre\" id=\"nombre\" type=\"text\" value=\"{{ resultado_db.nombre }}\" required=\"required\"/>
            </div>
            <div class=\"form-group\">
                <select name=\"cumplimiento\" id=\"cumplimiento\" class=\"form-control\">
                  <option value=\"1\">Cumple</option>
        ...
        <input class=\"form-control\" name=\"id_resultado\" id=\"id_resultado\" type=\"hidden\" value=\"{{ resultado_db.id_resultado }}\" required=\"required\"/>
      </form>
    </div>
  </div>
</section>
...
{% endblock %}
", "confirmacion/resultado/editar_resultado.twig", "C:\\xampp\\htdocs\\intranietsen\\app\\templates\\confirmacion\\resultado\\editar_resultado.twig");
    }
}
