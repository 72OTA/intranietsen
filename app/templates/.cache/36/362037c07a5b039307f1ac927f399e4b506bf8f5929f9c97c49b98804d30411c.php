...
class __TwigTemplate_d7cd9a6d13b0ee848b7e5f659530dfeaff60ab9a1c636431fce41fd387af532b extends Twig_Template
{
          ...
          <div class=\"box box-primary\">
            <form id=\"editar_comuna_form\"  action=\"\" method=\"POST\">
              ...
              <div class=\"box-body col-sm-4\">
                ...
                <div class=\"form-group\">
                    <input class=\"form-control\" name=\"comuna\" id=\"comuna\" type=\"text\" placeholder=\"Nombre de la comuna\" value='{{ db_comuna.nombre }}' required/>
                </div>
                <div class=\"panel-footer text-center\">
                  <button type=\"button\" id=\"update_comuna\" class=\"btn btn-default\">Grabar</button>
                </div>
...
{% endblock %}
", "confirmacion/comuna/editar_comuna.twig", "C:\\xampp\\htdocs\\intranietsen\\app\\templates\\confirmacion\\comuna\\editar_comuna.twig");
    }
}
