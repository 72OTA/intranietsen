...
class __TwigTemplate_8eb9ae4f155a8338189e1ae0f977449b7161dced170ec14de5837b8ddb413acd extends Twig_Template
{
        ...
        <div class=\"col-md-12\">
          <div class=\"box box-primary\">
            ...
            <table id=\"dataTables1\" class=\"table table-bordered\">
              ...
              <tbody>
                {% set No = 1 %}
                {% for d in motivocall_db if false != motivocall_db %}
                  <tr>
                    <td>{{ No }}</td>
                    <td>{{ d.motivo }}</td>
                    ...
                    <td class='center' width='80'>
                      <a data-toggle='tooltip' data-placement='top' title='Modificar' class='btn btn-success btn-sm' href=\"confirmacion/editar_motivocall/{{ d.id_motivo }}\">
                      <i class='glyphicon glyphicon-edit'></i>
                      </a>

                      {% if d.estado == 0 %}
                          <a data-toggle='tooltip' data-placement='top' title='Bloqueado' class='btn btn-warning btn-sm' href=\"confirmacion/estado_motivocall/{{ d.id_motivo }}\">
                          <i class='glyphicon glyphicon-off'></i>
                          </a>

                      {% else %}
                          <a data-toggle='tooltip' data-placement='top' title='Activo' class='btn btn-danger btn-sm' href=\"confirmacion/estado_motivocall/{{ d.id_motivo }}\">
                          <i class='glyphicon glyphicon-check'></i>
                          </a>
...
{% endblock %}
", "confirmacion/motivocall/listar_motivocall.twig", "C:\\xampp\\htdocs\\intranietsen\\app\\templates\\confirmacion\\motivocall\\listar_motivocall.twig");
    }
}
